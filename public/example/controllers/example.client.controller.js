...
$scope.asignaciones = [{'tipo':'Talleres','numeroIntentos':10,'ayudas':true, 'muestraSolucion':true,
                          'ejercicios':[{'guia':1, 'enabled': false,'nombre':'1-2-20a','tipoRespuesta':'valores'},
                                        ...
                                        {'guia':2, 'enabled': true,'nombre':'4-2-17a','tipoRespuesta':'valores'},
                                        {'guia':2, 'enabled': true,'nombre':'4-2-17b','tipoRespuesta':'valores'},
                                        {'guia':2, 'enabled': true,'nombre':'4-2-17c','tipoRespuesta':'valores'},
