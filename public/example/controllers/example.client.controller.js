...
$scope.asignaciones = [{'tipo':'Talleres','numeroIntentos':10,'ayudas':true, 'muestraSolucion':true,
                          'ejercicios':[{'guia':1, 'enabled': true,'nombre':'1-2-20a','tipoRespuesta':'valores'},
                                        ...
                                        {'guia':2, 'enabled': true,'nombre':'3-3-7','tipoRespuesta':'valores'},
                                        {'guia':2, 'enabled': true,'nombre':'3-3-10','tipoRespuesta':'valores'},
                                        {'guia':2, 'enabled': true,'nombre':'3-5-3','tipoRespuesta':'valores'},
                                        {'guia':2, 'enabled': true,'nombre':'4-2-17a','tipoRespuesta':'funcion'},
                                        {'guia':2, 'enabled': true,'nombre':'4-2-17b','tipoRespuesta':'funcion'},
                                        {'guia':2, 'enabled': true,'nombre':'4-2-17c','tipoRespuesta':'funcion'},
                                        {'guia':3, 'enabled': true,'nombre':'5-2-17','tipoRespuesta':'funcion'},
                                        {'guia':3, 'enabled': true,'nombre':'5-2-19','tipoRespuesta':'funcion'},
                                        {'guia':3, 'enabled': true,'nombre':'6-3-3a','tipoRespuesta':'funcion'},
                                        {'guia':3, 'enabled': true,'nombre':'6-3-3b','tipoRespuesta':'funcion'},
                                        {'guia':3, 'enabled': true,'nombre':'6-3-3c','tipoRespuesta':'funcion'},
                         ...
                         {'tipo':'Quices','numeroIntentos':1,'ayudas':false, 'muestraSolucion':false,
                          'ejercicios':[{'guia':1, 'enabled': false,'nombre':'1-2-20a','tipoRespuesta':'valores'},
                                        ...
                                        {'guia':3, 'enabled': false,'nombre':'5-2-17','tipoRespuesta':'funcion'},
                                        {'guia':3, 'enabled': false,'nombre':'5-2-19','tipoRespuesta':'funcion'},
